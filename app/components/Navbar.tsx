      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <a 
              href="/" 
              className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 px-2 md:px-3 py-2 rounded-md text-sm font-medium"
            >
              Home
            </a>
            {isSignedIn ? (
              ...
              <div className="flex items-center space-x-2">
                <SignInButton mode="modal">
                  <button className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 px-3 py-2 rounded-md text-sm font-medium">
                    Sign In
                  </button>
                </SignInButton>
